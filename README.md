...
- [polkit-gnome] recommend using the gnome-polkit as it integrates nicely for elevating programs that need root access
...
```
git clone https://github.com/CaasKop/material-awesome.git ~/.config/awesome
```
